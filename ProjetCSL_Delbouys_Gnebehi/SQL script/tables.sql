...
INSERT INTO STUDENTS_ATHLETES(student_id,points_awarded_to_date,first_name,middle_name,last_name,date_of_birth,gender,students_address,other_details) VALUES ('1234', 1000, 'PIRLO','ANDRE','CHACALO','1990-12-12','H','5 Avenue SERVE','happy');
INSERT INTO STUDENTS_ATHLETES(student_id,points_awarded_to_date,first_name,middle_name,last_name,date_of_birth,gender,students_address,other_details) VALUES ('1235', 1001, 'CAMOUANESI','ANDRES','RENARDO','1991-12-12','H','5 Avenue ERSAE','happy');
INSERT INTO STUDENTS_ATHLETES(student_id,points_awarded_to_date,first_name,middle_name,last_name,date_of_birth,gender,students_address,other_details) VALUES ('1236', 1002, 'MOTTA','THIAGO','SOURISS','1992-12-12','H','5 Avenue FRETER','happy');
INSERT INTO STUDENTS_ATHLETES(student_id,points_awarded_to_date,first_name,middle_name,last_name,date_of_birth,gender,students_address,other_details) VALUES ('1237', 1003, 'GATTUSO','ERWAN','FOUTOU','1993-12-12','H','5 Avenue DERTER','happy');
...
INSERT INTO STUDENTS_LETTERS(student_id,sport_code,date_awarded) VALUES ('1234','0000','2005-12-12');
INSERT INTO STUDENTS_LETTERS(student_id,sport_code,date_awarded) VALUES ('1235','0001','2005-12-12');
INSERT INTO STUDENTS_LETTERS(student_id,sport_code,date_awarded) VALUES ('1236','0002','2006-12-12');
INSERT INTO STUDENTS_LETTERS(student_id,sport_code,date_awarded) VALUES ('1237','0003','2007-12-12');
...
INSERT INTO TEAMS(team_id,gender,division_code,sport_code,team_date,team_description,coach_name,other_details) VALUES ('3333','H','2222','0000','2000-12-12','ITALIE','LILIANO','NONO');

INSERT INTO STUDENTS_IN_TEAMS(team_id,student_id) VALUES ('3333','1234');

INSERT INTO EVENTS(event_id,sport_code,event_name,event_location,start_date,end_date,other_details) VALUES ('5555','0000','GADJI CELI','ABIDJAN','2015-12-12','2016-03-12','HYDRO');
